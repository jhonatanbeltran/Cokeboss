...
class cliente_edit extends cliente
{
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_documento_cliente")) {
				$this->documento_cliente->setFormValue($CurrentForm->getValue("x_documento_cliente"));
			}
		} else {
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			$this->nombre_cliente->setDbValueDef($rsnew, $this->nombre_cliente->CurrentValue, NULL, $this->nombre_cliente->ReadOnly);

			// apellido_cliente
			$this->apellido_cliente->setDbValueDef($rsnew, $this->apellido_cliente->CurrentValue, NULL, $this->apellido_cliente->ReadOnly);

			// direccion_cliente
			$this->direccion_cliente->setDbValueDef($rsnew, $this->direccion_cliente->CurrentValue, NULL, $this->direccion_cliente->ReadOnly);

			// telefono_cliente
			$this->telefono_cliente->setDbValueDef($rsnew, $this->telefono_cliente->CurrentValue, NULL, $this->telefono_cliente->ReadOnly);
