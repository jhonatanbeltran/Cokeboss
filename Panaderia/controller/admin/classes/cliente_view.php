...
class cliente_view extends cliente
{
	...
	public function __construct()
	{
		...
		if (Get("documento_cliente") !== NULL) {
			$this->RecKey["documento_cliente"] = Get("documento_cliente");
			$keyUrl .= "&amp;documento_cliente=" . urlencode($this->RecKey["documento_cliente"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("documento_cliente") !== NULL) {
				...
				$this->RecKey["documento_cliente"] = $this->documento_cliente->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->documento_cliente->setQueryStringValue(Key(0));
				$this->RecKey["documento_cliente"] = $this->documento_cliente->QueryStringValue;
			} elseif (Post("documento_cliente") !== NULL) {
				$this->documento_cliente->setFormValue(Post("documento_cliente"));
				$this->RecKey["documento_cliente"] = $this->documento_cliente->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->documento_cliente->setFormValue(Route(2));
				$this->RecKey["documento_cliente"] = $this->documento_cliente->FormValue;
			} else {
