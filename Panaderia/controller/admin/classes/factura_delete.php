 ...
 * Page class
 */
class factura_delete extends factura
{
	...
	// Page object name
	public $PageObjName = "factura_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("facturalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("facturalist.php"); // Return to list
			}
		}
	}
