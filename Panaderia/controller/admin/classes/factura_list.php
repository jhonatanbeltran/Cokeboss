 ...
 * Page class
 */
class factura_list extends factura
{
	...
	// Page object name
	public $PageObjName = "factura_list";

	// Grid form hidden field names
	public $FormName = "ffacturalist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "facturaadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "facturadelete.php";
		$this->MultiUpdateUrl = "facturaupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ffacturalistsrch";
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 1) {
			$this->id_factura->setFormValue($arKeyFlds[0]);
		}
		return TRUE;
	}
	...
	public function getFilterList()
	{
		...
		$filterList = "";
		$savedFilterList = "";
		$filterList = Concat($filterList, $this->id_factura->AdvancedSearch->toJson(), ","); // Field id_factura
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ffacturalistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field id_factura
		$this->id_factura->AdvancedSearch->SearchValue = @$filter["x_id_factura"];
		$this->id_factura->AdvancedSearch->SearchOperator = @$filter["z_id_factura"];
		$this->id_factura->AdvancedSearch->SearchCondition = @$filter["v_id_factura"];
		$this->id_factura->AdvancedSearch->SearchValue2 = @$filter["y_id_factura"];
		$this->id_factura->AdvancedSearch->SearchOperator2 = @$filter["w_id_factura"];
		$this->id_factura->AdvancedSearch->save();
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->id_factura, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->id_compra, $arKeywords, $type);
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->id_factura); // id_factura
	...
	public function renderListOptions()
	{
		...
		$opt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ew-multi-select\" value=\"" . HtmlEncode($this->id_factura->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\">";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ffacturalistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ffacturalistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ffacturalist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ffacturalistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
