 ...
 * Page class
 */
class inventario_edit extends inventario
{
	...
	// Page object name
	public $PageObjName = "inventario_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_id_inventario")) {
				$this->id_inventario->setFormValue($CurrentForm->getValue("x_id_inventario"));
			}
			if ($CurrentForm->hasValue("x_fecha_inventario")) {
				$this->fecha_inventario->setFormValue($CurrentForm->getValue("x_fecha_inventario"));
			}
		} else {
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("inventariolist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "inventariolist.php")
