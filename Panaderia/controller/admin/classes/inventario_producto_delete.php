 ...
 * Page class
 */
class inventario_producto_delete extends inventario_producto
{
	...
	// Page object name
	public $PageObjName = "inventario_producto_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("inventario_productolist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("inventario_productolist.php"); // Return to list
			}
		}
	}
