 ...
 * Page class
 */
class inventario_producto_edit extends inventario_producto
{
	...
	// Page object name
	public $PageObjName = "inventario_producto_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			$this->cantidad_inv_producto->setDbValueDef($rsnew, $this->cantidad_inv_producto->CurrentValue, NULL, $this->cantidad_inv_producto->ReadOnly);
