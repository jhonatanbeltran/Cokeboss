 ...
 * Page class
 */
class inventario_temp_delete extends inventario_temp
{
	...
	// Page object name
	public $PageObjName = "inventario_temp_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("inventario_templist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("inventario_templist.php"); // Return to list
			}
		}
	}
