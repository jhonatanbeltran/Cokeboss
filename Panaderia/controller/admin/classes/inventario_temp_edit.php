 ...
 * Page class
 */
class inventario_temp_edit extends inventario_temp
{
	...
	// Page object name
	public $PageObjName = "inventario_temp_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_id_inventario_tmp")) {
				$this->id_inventario_tmp->setFormValue($CurrentForm->getValue("x_id_inventario_tmp"));
			}
		} else {
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			$this->id_item_orden->setDbValueDef($rsnew, $this->id_item_orden->CurrentValue, NULL, $this->id_item_orden->ReadOnly);

			// id_producto
			$this->id_producto->setDbValueDef($rsnew, $this->id_producto->CurrentValue, NULL, $this->id_producto->ReadOnly);

			// id_proceso
			$this->id_proceso->setDbValueDef($rsnew, $this->id_proceso->CurrentValue, NULL, $this->id_proceso->ReadOnly);
