 ...
 */
class producto extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id_producto
		$this->id_producto = new DbField('producto', 'producto', 'x_id_producto', 'id_producto', '`id_producto`', '`id_producto`', 200, -1, FALSE, '`id_producto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_tipo_producto
		$this->id_tipo_producto = new DbField('producto', 'producto', 'x_id_tipo_producto', 'id_tipo_producto', '`id_tipo_producto`', '`id_tipo_producto`', 200, -1, FALSE, '`id_tipo_producto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id_tipo_producto->Sortable = TRUE; // Allow sort
		$this->fields['id_tipo_producto'] = &$this->id_tipo_producto;

		// nombre_producto
		$this->nombre_producto = new DbField('producto', 'producto', 'x_nombre_producto', 'nombre_producto', '`nombre_producto`', '`nombre_producto`', 200, -1, FALSE, '`nombre_producto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nombre_producto->Sortable = TRUE; // Allow sort
		$this->fields['nombre_producto'] = &$this->nombre_producto;

		// estado_producto
		$this->estado_producto = new DbField('producto', 'producto', 'x_estado_producto', 'estado_producto', '`estado_producto`', '`estado_producto`', 16, -1, FALSE, '`estado_producto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->estado_producto->Sortable = TRUE; // Allow sort
		$this->estado_producto->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['estado_producto'] = &$this->estado_producto;

		// peso_producto
		$this->peso_producto = new DbField('producto', 'producto', 'x_peso_producto', 'peso_producto', '`peso_producto`', '`peso_producto`', 3, -1, FALSE, '`peso_producto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->peso_producto->Sortable = TRUE; // Allow sort
		$this->peso_producto->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['peso_producto'] = &$this->peso_producto;

		// descripcion_producto
		$this->descripcion_producto = new DbField('producto', 'producto', 'x_descripcion_producto', 'descripcion_producto', '`descripcion_producto`', '`descripcion_producto`', 200, -1, FALSE, '`descripcion_producto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->descripcion_producto->Sortable = TRUE; // Allow sort
		$this->fields['descripcion_producto'] = &$this->descripcion_producto;
	}
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`producto`";
	}
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->id_tipo_producto->DbValue = $row['id_tipo_producto'];
		$this->nombre_producto->DbValue = $row['nombre_producto'];
		$this->estado_producto->DbValue = $row['estado_producto'];
		$this->peso_producto->DbValue = $row['peso_producto'];
		$this->descripcion_producto->DbValue = $row['descripcion_producto'];
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "productoedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "productoadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("productoview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("productoview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "productoadd.php?" . $this->getUrlParm($parm);
		else
			$url = "productoadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("productoedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("productoadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("productodelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->id_tipo_producto->setDbValue($rs->fields('id_tipo_producto'));
		$this->nombre_producto->setDbValue($rs->fields('nombre_producto'));
		$this->estado_producto->setDbValue($rs->fields('estado_producto'));
		$this->peso_producto->setDbValue($rs->fields('peso_producto'));
		$this->descripcion_producto->setDbValue($rs->fields('descripcion_producto'));
	}
	...
	public function renderEditRow()
	{
		...
		$this->id_tipo_producto->EditValue = $this->id_tipo_producto->CurrentValue;
		...
		$this->estado_producto->EditValue = $this->estado_producto->CurrentValue;
		...
		$this->peso_producto->EditValue = $this->peso_producto->CurrentValue;
		...
		$this->descripcion_producto->EditValue = $this->descripcion_producto->CurrentValue;
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->id_tipo_producto);
					$doc->exportCaption($this->nombre_producto);
					$doc->exportCaption($this->estado_producto);
					$doc->exportCaption($this->peso_producto);
					$doc->exportCaption($this->descripcion_producto);
				} else {
					$doc->exportCaption($this->id_producto);
					$doc->exportCaption($this->id_tipo_producto);
					$doc->exportCaption($this->nombre_producto);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->id_tipo_producto);
						$doc->exportField($this->nombre_producto);
						$doc->exportField($this->estado_producto);
						$doc->exportField($this->peso_producto);
						$doc->exportField($this->descripcion_producto);
					} else {
						$doc->exportField($this->id_producto);
						$doc->exportField($this->id_tipo_producto);
						$doc->exportField($this->nombre_producto);
