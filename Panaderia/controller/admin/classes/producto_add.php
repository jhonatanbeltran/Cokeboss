 ...
 * Page class
 */
class producto_add extends producto
{
	...
	// Page object name
	public $PageObjName = "producto_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "productoview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_tipo_producto->CurrentValue = NULL;
		$this->id_tipo_producto->OldValue = $this->id_tipo_producto->CurrentValue;
		$this->nombre_producto->CurrentValue = NULL;
		$this->nombre_producto->OldValue = $this->nombre_producto->CurrentValue;
		$this->estado_producto->CurrentValue = NULL;
		$this->estado_producto->OldValue = $this->estado_producto->CurrentValue;
		$this->peso_producto->CurrentValue = NULL;
		$this->peso_producto->OldValue = $this->peso_producto->CurrentValue;
		$this->descripcion_producto->CurrentValue = NULL;
		$this->descripcion_producto->OldValue = $this->descripcion_producto->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row['id_tipo_producto'] = $this->id_tipo_producto->CurrentValue;
		$row['nombre_producto'] = $this->nombre_producto->CurrentValue;
		$row['estado_producto'] = $this->estado_producto->CurrentValue;
		$row['peso_producto'] = $this->peso_producto->CurrentValue;
		$row['descripcion_producto'] = $this->descripcion_producto->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// id_tipo_producto
		$this->id_tipo_producto->setDbValueDef($rsnew, $this->id_tipo_producto->CurrentValue, NULL, FALSE);

		// nombre_producto
		$this->nombre_producto->setDbValueDef($rsnew, $this->nombre_producto->CurrentValue, NULL, FALSE);

		// estado_producto
		$this->estado_producto->setDbValueDef($rsnew, $this->estado_producto->CurrentValue, NULL, FALSE);

		// peso_producto
		$this->peso_producto->setDbValueDef($rsnew, $this->peso_producto->CurrentValue, NULL, FALSE);

		// descripcion_producto
		$this->descripcion_producto->setDbValueDef($rsnew, $this->descripcion_producto->CurrentValue, NULL, FALSE);
