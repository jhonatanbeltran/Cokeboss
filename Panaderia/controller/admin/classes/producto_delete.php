 ...
 * Page class
 */
class producto_delete extends producto
{
	...
	// Page object name
	public $PageObjName = "producto_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("productolist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("productolist.php"); // Return to list
			}
		}
	}
