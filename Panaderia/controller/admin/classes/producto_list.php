 ...
 * Page class
 */
class producto_list extends producto
{
	...
	// Page object name
	public $PageObjName = "producto_list";

	// Grid form hidden field names
	public $FormName = "fproductolist";
	...
	public function __construct()
	{
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fproductolistsrch";
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->id_tipo_producto->AdvancedSearch->toJson(), ","); // Field id_tipo_producto
		$filterList = Concat($filterList, $this->nombre_producto->AdvancedSearch->toJson(), ","); // Field nombre_producto
		$filterList = Concat($filterList, $this->estado_producto->AdvancedSearch->toJson(), ","); // Field estado_producto
		$filterList = Concat($filterList, $this->peso_producto->AdvancedSearch->toJson(), ","); // Field peso_producto
		$filterList = Concat($filterList, $this->descripcion_producto->AdvancedSearch->toJson(), ","); // Field descripcion_producto
		if ($this->BasicSearch->Keyword <> "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fproductolistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		$this->id_tipo_producto->AdvancedSearch->SearchValue = @$filter["x_id_tipo_producto"];
		$this->id_tipo_producto->AdvancedSearch->SearchOperator = @$filter["z_id_tipo_producto"];
		$this->id_tipo_producto->AdvancedSearch->SearchCondition = @$filter["v_id_tipo_producto"];
		$this->id_tipo_producto->AdvancedSearch->SearchValue2 = @$filter["y_id_tipo_producto"];
		$this->id_tipo_producto->AdvancedSearch->SearchOperator2 = @$filter["w_id_tipo_producto"];
		$this->id_tipo_producto->AdvancedSearch->save();
		...
		$this->estado_producto->AdvancedSearch->SearchValue = @$filter["x_estado_producto"];
		$this->estado_producto->AdvancedSearch->SearchOperator = @$filter["z_estado_producto"];
		$this->estado_producto->AdvancedSearch->SearchCondition = @$filter["v_estado_producto"];
		$this->estado_producto->AdvancedSearch->SearchValue2 = @$filter["y_estado_producto"];
		$this->estado_producto->AdvancedSearch->SearchOperator2 = @$filter["w_estado_producto"];
		$this->estado_producto->AdvancedSearch->save();

		// Field peso_producto
		$this->peso_producto->AdvancedSearch->SearchValue = @$filter["x_peso_producto"];
		$this->peso_producto->AdvancedSearch->SearchOperator = @$filter["z_peso_producto"];
		$this->peso_producto->AdvancedSearch->SearchCondition = @$filter["v_peso_producto"];
		$this->peso_producto->AdvancedSearch->SearchValue2 = @$filter["y_peso_producto"];
		$this->peso_producto->AdvancedSearch->SearchOperator2 = @$filter["w_peso_producto"];
		$this->peso_producto->AdvancedSearch->save();

		// Field descripcion_producto
		$this->descripcion_producto->AdvancedSearch->SearchValue = @$filter["x_descripcion_producto"];
		$this->descripcion_producto->AdvancedSearch->SearchOperator = @$filter["z_descripcion_producto"];
		$this->descripcion_producto->AdvancedSearch->SearchCondition = @$filter["v_descripcion_producto"];
		$this->descripcion_producto->AdvancedSearch->SearchValue2 = @$filter["y_descripcion_producto"];
		$this->descripcion_producto->AdvancedSearch->SearchOperator2 = @$filter["w_descripcion_producto"];
		$this->descripcion_producto->AdvancedSearch->save();
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->id_tipo_producto, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->nombre_producto, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->descripcion_producto, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->id_tipo_producto); // id_tipo_producto
			$this->updateSort($this->nombre_producto); // nombre_producto
			$this->updateSort($this->estado_producto); // estado_producto
			$this->updateSort($this->peso_producto); // peso_producto
			$this->updateSort($this->descripcion_producto); // descripcion_producto
	...
	protected function resetCmd()
	{
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->id_tipo_producto->setSort("");
				$this->nombre_producto->setSort("");
				$this->estado_producto->setSort("");
				$this->peso_producto->setSort("");
				$this->descripcion_producto->setSort("");
			}
	...
	public function renderListOptions()
	{
		...
		$opt->Body = "<input type=\"checkbox\" name=\"key_m[]\" class=\"ew-multi-select\" value=\"" . HtmlEncode($this->id_producto->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\">";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fproductolistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fproductolistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.fproductolist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fproductolistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
