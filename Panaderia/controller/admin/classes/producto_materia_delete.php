 ...
 * Page class
 */
class producto_materia_delete extends producto_materia
{
	...
	// Page object name
	public $PageObjName = "producto_materia_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("producto_materialist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("producto_materialist.php"); // Return to list
			}
		}
	}
