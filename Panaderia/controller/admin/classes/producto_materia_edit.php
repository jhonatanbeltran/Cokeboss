 ...
 * Page class
 */
class producto_materia_edit extends producto_materia
{
	...
	// Page object name
	public $PageObjName = "producto_materia_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// peso_producto_materia
			$this->peso_producto_materia->setDbValueDef($rsnew, $this->peso_producto_materia->CurrentValue, NULL, $this->peso_producto_materia->ReadOnly);

			// cantidad_producto_materia
			$this->cantidad_producto_materia->setDbValueDef($rsnew, $this->cantidad_producto_materia->CurrentValue, NULL, $this->cantidad_producto_materia->ReadOnly);
