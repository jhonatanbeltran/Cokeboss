 ...
 * Page class
 */
class producto_materia_view extends producto_materia
{
	...
	// Page object name
	public $PageObjName = "producto_materia_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if (Get("id_producto") !== NULL) {
				...
				$this->id_producto->setFormValue(Route(3));
				$this->RecKey["id_producto"] = $this->id_producto->FormValue;
			} else {
				$returnUrl = "producto_materialist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "producto_materialist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "producto_materialist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
