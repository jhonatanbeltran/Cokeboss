 ...
 * Page class
 */
class producto_proceso_view extends producto_proceso
{
	...
	// Page object name
	public $PageObjName = "producto_proceso_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if (Get("id_proceso") !== NULL) {
				...
				$this->id_proceso->setFormValue(Route(3));
				$this->RecKey["id_proceso"] = $this->id_proceso->FormValue;
			} else {
				$returnUrl = "producto_procesolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "producto_procesolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "producto_procesolist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
