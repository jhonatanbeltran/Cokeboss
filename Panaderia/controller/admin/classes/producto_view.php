 ...
 * Page class
 */
class producto_view extends producto
{
	...
	// Page object name
	public $PageObjName = "producto_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_producto") !== NULL) {
				...
				$returnUrl = "productolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "productolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "productolist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
