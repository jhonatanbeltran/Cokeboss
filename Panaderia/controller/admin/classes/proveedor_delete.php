 ...
 * Page class
 */
class proveedor_delete extends proveedor
{
	...
	// Page object name
	public $PageObjName = "proveedor_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("proveedorlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("proveedorlist.php"); // Return to list
			}
		}
	}
