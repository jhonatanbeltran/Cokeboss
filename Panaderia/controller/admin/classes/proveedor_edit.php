 ...
 * Page class
 */
class proveedor_edit extends proveedor
{
	...
	// Page object name
	public $PageObjName = "proveedor_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_id_proveedor")) {
				$this->id_proveedor->setFormValue($CurrentForm->getValue("x_id_proveedor"));
			}
		} else {
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			$this->nombre_proveedor->setDbValueDef($rsnew, $this->nombre_proveedor->CurrentValue, NULL, $this->nombre_proveedor->ReadOnly);

			// direccion_proveedor
			$this->direccion_proveedor->setDbValueDef($rsnew, $this->direccion_proveedor->CurrentValue, NULL, $this->direccion_proveedor->ReadOnly);

			// telefono_proveedor
			$this->telefono_proveedor->setDbValueDef($rsnew, $this->telefono_proveedor->CurrentValue, NULL, $this->telefono_proveedor->ReadOnly);

			// descripcion_proveedor
			$this->descripcion_proveedor->setDbValueDef($rsnew, $this->descripcion_proveedor->CurrentValue, NULL, $this->descripcion_proveedor->ReadOnly);
