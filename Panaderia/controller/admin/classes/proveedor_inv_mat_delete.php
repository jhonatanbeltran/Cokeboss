 ...
 * Page class
 */
class proveedor_inv_mat_delete extends proveedor_inv_mat
{
	...
	// Page object name
	public $PageObjName = "proveedor_inv_mat_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("proveedor_inv_matlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("proveedor_inv_matlist.php"); // Return to list
			}
		}
	}
	...
	protected function deleteRows()
	{
		...
		if ($deleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$thisKey .= $row['id_proveedor_inv_mat'];
