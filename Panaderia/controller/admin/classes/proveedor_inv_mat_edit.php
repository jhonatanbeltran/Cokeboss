 ...
 * Page class
 */
class proveedor_inv_mat_edit extends proveedor_inv_mat
{
	...
	// Page object name
	public $PageObjName = "proveedor_inv_mat_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_id_proveedor_inv_mat")) {
				$this->id_proveedor_inv_mat->setFormValue($CurrentForm->getValue("x_id_proveedor_inv_mat"));
			}
		} else {
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// id_materia_prima
			$this->id_materia_prima->setDbValueDef($rsnew, $this->id_materia_prima->CurrentValue, NULL, $this->id_materia_prima->ReadOnly);

			// id_inventario
			$this->id_inventario->setDbValueDef($rsnew, $this->id_inventario->CurrentValue, NULL, $this->id_inventario->ReadOnly);

			// fecha_inventario
			$this->fecha_inventario->setDbValueDef($rsnew, $this->fecha_inventario->CurrentValue, NULL, $this->fecha_inventario->ReadOnly);

			// cantidad_proveedor_inv_mat
			$this->cantidad_proveedor_inv_mat->setDbValueDef($rsnew, $this->cantidad_proveedor_inv_mat->CurrentValue, NULL, $this->cantidad_proveedor_inv_mat->ReadOnly);
