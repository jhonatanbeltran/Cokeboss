...
class usuario_view extends usuario
{
	...
	public function __construct()
	{
		...
		if (Get("Identificador") !== NULL) {
			$this->RecKey["Identificador"] = Get("Identificador");
			$keyUrl .= "&amp;Identificador=" . urlencode($this->RecKey["Identificador"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("Identificador") !== NULL) {
				...
				$this->RecKey["Identificador"] = $this->Identificador->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->Identificador->setQueryStringValue(Key(0));
				$this->RecKey["Identificador"] = $this->Identificador->QueryStringValue;
			} elseif (Post("Identificador") !== NULL) {
				$this->Identificador->setFormValue(Post("Identificador"));
				$this->RecKey["Identificador"] = $this->Identificador->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->Identificador->setFormValue(Route(2));
				$this->RecKey["Identificador"] = $this->Identificador->FormValue;
			} else {
