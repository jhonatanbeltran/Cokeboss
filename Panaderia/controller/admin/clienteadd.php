...
var fclienteadd = currentForm = new ew.Form("fclienteadd", "add");
...
fclienteadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($cliente_add->documento_cliente->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_add->nombre_cliente->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_add->apellido_cliente->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_add->direccion_cliente->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_add->telefono_cliente->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_add->id_tipo_cliente->Required) { ?>
...
fclienteadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $cliente_add->Token ?>">
<?php } ?>
...
<?php if ($cliente->documento_cliente->Visible) { // documento_cliente ?>
	<div id="r_documento_cliente" class="form-group row">
		<label id="elh_cliente_documento_cliente" for="x_documento_cliente" class="<?php echo $cliente_add->LeftColumnClass ?>"><?php echo $cliente->documento_cliente->caption() ?><?php echo ($cliente->documento_cliente->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_add->RightColumnClass ?>"><div<?php echo $cliente->documento_cliente->cellAttributes() ?>>
<span id="el_cliente_documento_cliente">
<input type="text" data-table="cliente" data-field="x_documento_cliente" name="x_documento_cliente" id="x_documento_cliente" size="30" maxlength="15" placeholder="<?php echo HtmlEncode($cliente->documento_cliente->getPlaceHolder()) ?>" value="<?php echo $cliente->documento_cliente->EditValue ?>"<?php echo $cliente->documento_cliente->editAttributes() ?>>
</span>
...
<?php if ($cliente->nombre_cliente->Visible) { // nombre_cliente ?>
	<div id="r_nombre_cliente" class="form-group row">
		<label id="elh_cliente_nombre_cliente" for="x_nombre_cliente" class="<?php echo $cliente_add->LeftColumnClass ?>"><?php echo $cliente->nombre_cliente->caption() ?><?php echo ($cliente->nombre_cliente->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_add->RightColumnClass ?>"><div<?php echo $cliente->nombre_cliente->cellAttributes() ?>>
...
<?php if ($cliente->apellido_cliente->Visible) { // apellido_cliente ?>
	<div id="r_apellido_cliente" class="form-group row">
		<label id="elh_cliente_apellido_cliente" for="x_apellido_cliente" class="<?php echo $cliente_add->LeftColumnClass ?>"><?php echo $cliente->apellido_cliente->caption() ?><?php echo ($cliente->apellido_cliente->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_add->RightColumnClass ?>"><div<?php echo $cliente->apellido_cliente->cellAttributes() ?>>
...
<?php if ($cliente->direccion_cliente->Visible) { // direccion_cliente ?>
	<div id="r_direccion_cliente" class="form-group row">
		<label id="elh_cliente_direccion_cliente" for="x_direccion_cliente" class="<?php echo $cliente_add->LeftColumnClass ?>"><?php echo $cliente->direccion_cliente->caption() ?><?php echo ($cliente->direccion_cliente->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_add->RightColumnClass ?>"><div<?php echo $cliente->direccion_cliente->cellAttributes() ?>>
...
<?php if ($cliente->telefono_cliente->Visible) { // telefono_cliente ?>
	<div id="r_telefono_cliente" class="form-group row">
		<label id="elh_cliente_telefono_cliente" for="x_telefono_cliente" class="<?php echo $cliente_add->LeftColumnClass ?>"><?php echo $cliente->telefono_cliente->caption() ?><?php echo ($cliente->telefono_cliente->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_add->RightColumnClass ?>"><div<?php echo $cliente->telefono_cliente->cellAttributes() ?>>
...
<?php if ($cliente->id_tipo_cliente->Visible) { // id_tipo_cliente ?>
	<div id="r_id_tipo_cliente" class="form-group row">
		<label id="elh_cliente_id_tipo_cliente" for="x_id_tipo_cliente" class="<?php echo $cliente_add->LeftColumnClass ?>"><?php echo $cliente->id_tipo_cliente->caption() ?><?php echo ($cliente->id_tipo_cliente->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_add->RightColumnClass ?>"><div<?php echo $cliente->id_tipo_cliente->cellAttributes() ?>>
...
<?php if ($cliente->_email->Visible) { // email ?>
	<div id="r__email" class="form-group row">
		<label id="elh_cliente__email" for="x__email" class="<?php echo $cliente_add->LeftColumnClass ?>"><?php echo $cliente->_email->caption() ?><?php echo ($cliente->_email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
