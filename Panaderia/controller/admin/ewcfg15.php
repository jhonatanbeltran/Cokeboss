...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'oCRttWmV42I9M6rN'); // Random key for encryption
...
$PROJECT_ID = "{32EED04B-7492-488D-88BA-E849477D8825}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "cakeboss", "qs" => "`", "qe" => "`");
