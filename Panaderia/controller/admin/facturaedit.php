...
var ffacturaedit = currentForm = new ew.Form("ffacturaedit", "edit");

// Validate form
ffacturaedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($factura_edit->id_factura->Required) { ?>
		...
		<?php } ?>
		<?php if ($factura_edit->id_compra->Required) { ?>
		...
		<?php } ?>
		<?php if ($factura_edit->id_proveedor_inv_mat->Required) { ?>
		...
		<?php } ?>
		<?php if ($factura_edit->cantidad->Required) { ?>
		...
		<?php if ($factura_edit->precio->Required) { ?>
		...
		<?php if ($factura_edit->iva->Required) { ?>
		...
		<?php if ($factura_edit->total->Required) { ?>
		...
		<?php if ($factura_edit->fecha->Required) { ?>
...
ffacturaedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ffacturaedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $factura_edit->showPageHeader(); ?>
<?php
$factura_edit->showMessage();
?>
<form name="ffacturaedit" id="ffacturaedit" class="<?php echo $factura_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($factura_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $factura_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="factura">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$factura_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($factura->id_factura->Visible) { // id_factura ?>
	<div id="r_id_factura" class="form-group row">
		<label id="elh_factura_id_factura" for="x_id_factura" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->id_factura->caption() ?><?php echo ($factura->id_factura->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->id_factura->cellAttributes() ?>>
<span id="el_factura_id_factura">
<span<?php echo $factura->id_factura->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($factura->id_factura->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="factura" data-field="x_id_factura" name="x_id_factura" id="x_id_factura" value="<?php echo HtmlEncode($factura->id_factura->CurrentValue) ?>">
...
<?php if ($factura->id_compra->Visible) { // id_compra ?>
	<div id="r_id_compra" class="form-group row">
		<label id="elh_factura_id_compra" for="x_id_compra" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->id_compra->caption() ?><?php echo ($factura->id_compra->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->id_compra->cellAttributes() ?>>
...
<?php if ($factura->id_proveedor_inv_mat->Visible) { // id_proveedor_inv_mat ?>
	<div id="r_id_proveedor_inv_mat" class="form-group row">
		<label id="elh_factura_id_proveedor_inv_mat" for="x_id_proveedor_inv_mat" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->id_proveedor_inv_mat->caption() ?><?php echo ($factura->id_proveedor_inv_mat->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->id_proveedor_inv_mat->cellAttributes() ?>>
...
<?php if ($factura->cantidad->Visible) { // cantidad ?>
	<div id="r_cantidad" class="form-group row">
		<label id="elh_factura_cantidad" for="x_cantidad" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->cantidad->caption() ?><?php echo ($factura->cantidad->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->cantidad->cellAttributes() ?>>
...
<?php if ($factura->precio->Visible) { // precio ?>
	<div id="r_precio" class="form-group row">
		<label id="elh_factura_precio" for="x_precio" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->precio->caption() ?><?php echo ($factura->precio->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->precio->cellAttributes() ?>>
...
<?php if ($factura->iva->Visible) { // iva ?>
	<div id="r_iva" class="form-group row">
		<label id="elh_factura_iva" for="x_iva" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->iva->caption() ?><?php echo ($factura->iva->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->iva->cellAttributes() ?>>
...
<?php if ($factura->total->Visible) { // total ?>
	<div id="r_total" class="form-group row">
		<label id="elh_factura_total" for="x_total" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->total->caption() ?><?php echo ($factura->total->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->total->cellAttributes() ?>>
...
<?php if ($factura->fecha->Visible) { // fecha ?>
	<div id="r_fecha" class="form-group row">
		<label id="elh_factura_fecha" for="x_fecha" class="<?php echo $factura_edit->LeftColumnClass ?>"><?php echo $factura->fecha->caption() ?><?php echo ($factura->fecha->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $factura_edit->RightColumnClass ?>"><div<?php echo $factura->fecha->cellAttributes() ?>>
...
<?php if (!$factura_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $factura_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $factura_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$factura_edit->showPageFooter();
if (DEBUG_ENABLED)
