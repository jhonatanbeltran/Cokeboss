...
<link rel="stylesheet" href="https://cdnjs.cloudfare.com/ajax/libs/font-awesome/4.7.0/cs/font-awesome.min.css">
...
<div class="wrapper ew-layout">
	...
	<!-- Navbar -->
	<nav class="<?php echo $NAVBAR_CLASS ?>" style="background-color: #ff8000 !important;">
		<!-- Left navbar links -->
	...
	<aside class="<?php echo $SIDEBAR_CLASS ?>">
		...
		<a href="#" class="brand-link">
			<span class="brand-text">Cakeboss Bienvenido 
			<center><a  href="../logout.php" style="color:#fff; " > Cerrar sesión <i class = "fa fa-power-off"></a></center>
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
			<!-- Sidebar Menu -->
