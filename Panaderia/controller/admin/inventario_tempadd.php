...
// Create page object
$inventario_temp_add = new inventario_temp_add();

// Run the page
$inventario_temp_add->run();
...
$inventario_temp_add->Page_Render();
?>
...
var finventario_tempadd = currentForm = new ew.Form("finventario_tempadd", "add");

// Validate form
finventario_tempadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($inventario_temp_add->id_inventario_tmp->Required) { ?>
		...
		<?php } ?>
		<?php if ($inventario_temp_add->id_item_orden->Required) { ?>
		...
		<?php } ?>
		<?php if ($inventario_temp_add->id_producto->Required) { ?>
		...
		<?php } ?>
		<?php if ($inventario_temp_add->id_proceso->Required) { ?>
		...
		<?php } ?>
		<?php if ($inventario_temp_add->estado->Required) { ?>
		...
		<?php if ($inventario_temp_add->tiempo->Required) { ?>
		...
		<?php if ($inventario_temp_add->descripcion->Required) { ?>
...
finventario_tempadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
finventario_tempadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $inventario_temp_add->showPageHeader(); ?>
<?php
$inventario_temp_add->showMessage();
?>
<form name="finventario_tempadd" id="finventario_tempadd" class="<?php echo $inventario_temp_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($inventario_temp_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $inventario_temp_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="inventario_temp">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$inventario_temp_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($inventario_temp->id_inventario_tmp->Visible) { // id_inventario_tmp ?>
	<div id="r_id_inventario_tmp" class="form-group row">
		<label id="elh_inventario_temp_id_inventario_tmp" for="x_id_inventario_tmp" class="<?php echo $inventario_temp_add->LeftColumnClass ?>"><?php echo $inventario_temp->id_inventario_tmp->caption() ?><?php echo ($inventario_temp->id_inventario_tmp->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inventario_temp_add->RightColumnClass ?>"><div<?php echo $inventario_temp->id_inventario_tmp->cellAttributes() ?>>
<span id="el_inventario_temp_id_inventario_tmp">
<input type="text" data-table="inventario_temp" data-field="x_id_inventario_tmp" name="x_id_inventario_tmp" id="x_id_inventario_tmp" size="30" maxlength="15" placeholder="<?php echo HtmlEncode($inventario_temp->id_inventario_tmp->getPlaceHolder()) ?>" value="<?php echo $inventario_temp->id_inventario_tmp->EditValue ?>"<?php echo $inventario_temp->id_inventario_tmp->editAttributes() ?>>
</span>
...
<?php if ($inventario_temp->id_item_orden->Visible) { // id_item_orden ?>
	<div id="r_id_item_orden" class="form-group row">
		<label id="elh_inventario_temp_id_item_orden" for="x_id_item_orden" class="<?php echo $inventario_temp_add->LeftColumnClass ?>"><?php echo $inventario_temp->id_item_orden->caption() ?><?php echo ($inventario_temp->id_item_orden->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inventario_temp_add->RightColumnClass ?>"><div<?php echo $inventario_temp->id_item_orden->cellAttributes() ?>>
...
<?php if ($inventario_temp->id_producto->Visible) { // id_producto ?>
	<div id="r_id_producto" class="form-group row">
		<label id="elh_inventario_temp_id_producto" for="x_id_producto" class="<?php echo $inventario_temp_add->LeftColumnClass ?>"><?php echo $inventario_temp->id_producto->caption() ?><?php echo ($inventario_temp->id_producto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inventario_temp_add->RightColumnClass ?>"><div<?php echo $inventario_temp->id_producto->cellAttributes() ?>>
...
<?php if ($inventario_temp->id_proceso->Visible) { // id_proceso ?>
	<div id="r_id_proceso" class="form-group row">
		<label id="elh_inventario_temp_id_proceso" for="x_id_proceso" class="<?php echo $inventario_temp_add->LeftColumnClass ?>"><?php echo $inventario_temp->id_proceso->caption() ?><?php echo ($inventario_temp->id_proceso->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inventario_temp_add->RightColumnClass ?>"><div<?php echo $inventario_temp->id_proceso->cellAttributes() ?>>
...
<?php if ($inventario_temp->estado->Visible) { // estado ?>
	<div id="r_estado" class="form-group row">
		<label id="elh_inventario_temp_estado" for="x_estado" class="<?php echo $inventario_temp_add->LeftColumnClass ?>"><?php echo $inventario_temp->estado->caption() ?><?php echo ($inventario_temp->estado->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inventario_temp_add->RightColumnClass ?>"><div<?php echo $inventario_temp->estado->cellAttributes() ?>>
...
<?php if ($inventario_temp->tiempo->Visible) { // tiempo ?>
	<div id="r_tiempo" class="form-group row">
		<label id="elh_inventario_temp_tiempo" for="x_tiempo" class="<?php echo $inventario_temp_add->LeftColumnClass ?>"><?php echo $inventario_temp->tiempo->caption() ?><?php echo ($inventario_temp->tiempo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inventario_temp_add->RightColumnClass ?>"><div<?php echo $inventario_temp->tiempo->cellAttributes() ?>>
...
<?php if ($inventario_temp->descripcion->Visible) { // descripcion ?>
	<div id="r_descripcion" class="form-group row">
		<label id="elh_inventario_temp_descripcion" for="x_descripcion" class="<?php echo $inventario_temp_add->LeftColumnClass ?>"><?php echo $inventario_temp->descripcion->caption() ?><?php echo ($inventario_temp->descripcion->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $inventario_temp_add->RightColumnClass ?>"><div<?php echo $inventario_temp->descripcion->cellAttributes() ?>>
...
<?php if (!$inventario_temp_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $inventario_temp_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $inventario_temp_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$inventario_temp_add->showPageFooter();
if (DEBUG_ENABLED)
