...
var fpedidoadd = currentForm = new ew.Form("fpedidoadd", "add");
...
fpedidoadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($pedido_add->id_pedido->Required) { ?>
		...
		<?php } ?>
		<?php if ($pedido_add->documento_cliente->Required) { ?>
		...
		<?php } ?>
		<?php if ($pedido_add->id_producto->Required) { ?>
		...
		<?php } ?>
		<?php if ($pedido_add->id_inventario->Required) { ?>
		...
		<?php } ?>
		<?php if ($pedido_add->fecha_inventario->Required) { ?>
		...
		<?php if ($pedido_add->cantidad_pedido->Required) { ?>
		...
		<?php if ($pedido_add->precio_pedido->Required) { ?>
		...
		<?php if ($pedido_add->tiempo_pedido->Required) { ?>
		...
		<?php if ($pedido_add->estado->Required) { ?>
		...
		<?php if ($pedido_add->total_pedido->Required) { ?>
...
fpedidoadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $pedido_add->Token ?>">
<?php } ?>
...
<?php if ($pedido->id_pedido->Visible) { // id_pedido ?>
	<div id="r_id_pedido" class="form-group row">
		<label id="elh_pedido_id_pedido" for="x_id_pedido" class="<?php echo $pedido_add->LeftColumnClass ?>"><?php echo $pedido->id_pedido->caption() ?><?php echo ($pedido->id_pedido->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pedido_add->RightColumnClass ?>"><div<?php echo $pedido->id_pedido->cellAttributes() ?>>
<span id="el_pedido_id_pedido">
<input type="text" data-table="pedido" data-field="x_id_pedido" name="x_id_pedido" id="x_id_pedido" size="30" maxlength="15" placeholder="<?php echo HtmlEncode($pedido->id_pedido->getPlaceHolder()) ?>" value="<?php echo $pedido->id_pedido->EditValue ?>"<?php echo $pedido->id_pedido->editAttributes() ?>>
</span>
...
<?php if ($pedido->documento_cliente->Visible) { // documento_cliente ?>
	<div id="r_documento_cliente" class="form-group row">
		<label id="elh_pedido_documento_cliente" for="x_documento_cliente" class="<?php echo $pedido_add->LeftColumnClass ?>"><?php echo $pedido->documento_cliente->caption() ?><?php echo ($pedido->documento_cliente->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pedido_add->RightColumnClass ?>"><div<?php echo $pedido->documento_cliente->cellAttributes() ?>>
...
<?php if ($pedido->id_producto->Visible) { // id_producto ?>
	<div id="r_id_producto" class="form-group row">
		<label id="elh_pedido_id_producto" for="x_id_producto" class="<?php echo $pedido_add->LeftColumnClass ?>"><?php echo $pedido->id_producto->caption() ?><?php echo ($pedido->id_producto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pedido_add->RightColumnClass ?>"><div<?php echo $pedido->id_producto->cellAttributes() ?>>
...
<?php if ($pedido->id_inventario->Visible) { // id_inventario ?>
	<div id="r_id_inventario" class="form-group row">
		<label id="elh_pedido_id_inventario" for="x_id_inventario" class="<?php echo $pedido_add->LeftColumnClass ?>"><?php echo $pedido->id_inventario->caption() ?><?php echo ($pedido->id_inventario->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pedido_add->RightColumnClass ?>"><div<?php echo $pedido->id_inventario->cellAttributes() ?>>
...
<?php if ($pedido->fecha_inventario->Visible) { // fecha_inventario ?>
	<div id="r_fecha_inventario" class="form-group row">
		<label id="elh_pedido_fecha_inventario" for="x_fecha_inventario" class="<?php echo $pedido_add->LeftColumnClass ?>"><?php echo $pedido->fecha_inventario->caption() ?><?php echo ($pedido->fecha_inventario->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pedido_add->RightColumnClass ?>"><div<?php echo $pedido->fecha_inventario->cellAttributes() ?>>
...
<?php if ($pedido->cantidad_pedido->Visible) { // cantidad_pedido ?>
	<div id="r_cantidad_pedido" class="form-group row">
		<label id="elh_pedido_cantidad_pedido" for="x_cantidad_pedido" class="<?php echo $pedido_add->LeftColumnClass ?>"><?php echo $pedido->cantidad_pedido->caption() ?><?php echo ($pedido->cantidad_pedido->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pedido_add->RightColumnClass ?>"><div<?php echo $pedido->cantidad_pedido->cellAttributes() ?>>
...
<?php if ($pedido->precio_pedido->Visible) { // precio_pedido ?>
	<div id="r_precio_pedido" class="form-group row">
		<label id="elh_pedido_precio_pedido" for="x_precio_pedido" class="<?php echo $pedido_add->LeftColumnClass ?>"><?php echo $pedido->precio_pedido->caption() ?><?php echo ($pedido->precio_pedido->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pedido_add->RightColumnClass ?>"><div<?php echo $pedido->precio_pedido->cellAttributes() ?>>
...
<?php if ($pedido->tiempo_pedido->Visible) { // tiempo_pedido ?>
	<div id="r_tiempo_pedido" class="form-group row">
		<label id="elh_pedido_tiempo_pedido" for="x_tiempo_pedido" class="<?php echo $pedido_add->LeftColumnClass ?>"><?php echo $pedido->tiempo_pedido->caption() ?><?php echo ($pedido->tiempo_pedido->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pedido_add->RightColumnClass ?>"><div<?php echo $pedido->tiempo_pedido->cellAttributes() ?>>
...
<?php if ($pedido->estado->Visible) { // estado ?>
	<div id="r_estado" class="form-group row">
		<label id="elh_pedido_estado" for="x_estado" class="<?php echo $pedido_add->LeftColumnClass ?>"><?php echo $pedido->estado->caption() ?><?php echo ($pedido->estado->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pedido_add->RightColumnClass ?>"><div<?php echo $pedido->estado->cellAttributes() ?>>
...
<?php if ($pedido->total_pedido->Visible) { // total_pedido ?>
	<div id="r_total_pedido" class="form-group row">
		<label id="elh_pedido_total_pedido" for="x_total_pedido" class="<?php echo $pedido_add->LeftColumnClass ?>"><?php echo $pedido->total_pedido->caption() ?><?php echo ($pedido->total_pedido->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $pedido_add->RightColumnClass ?>"><div<?php echo $pedido->total_pedido->cellAttributes() ?>>
