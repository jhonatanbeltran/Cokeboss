...
// Create page object
$producto_edit = new producto_edit();
...
var fproductoedit = currentForm = new ew.Form("fproductoedit", "edit");
...
fproductoedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($producto_edit->id_producto->Required) { ?>
		...
		<?php } ?>
		<?php if ($producto_edit->id_tipo_producto->Required) { ?>
		...
		<?php } ?>
		<?php if ($producto_edit->nombre_producto->Required) { ?>
		...
		<?php } ?>
		<?php if ($producto_edit->estado_producto->Required) { ?>
		...
		<?php if ($producto_edit->peso_producto->Required) { ?>
		...
		<?php if ($producto_edit->descripcion_producto->Required) { ?>
...
fproductoedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fproductoedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
?>
<form name="fproductoedit" id="fproductoedit" class="<?php echo $producto_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($producto_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $producto_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="producto">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$producto_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($producto->id_producto->Visible) { // id_producto ?>
	<div id="r_id_producto" class="form-group row">
		<label id="elh_producto_id_producto" for="x_id_producto" class="<?php echo $producto_edit->LeftColumnClass ?>"><?php echo $producto->id_producto->caption() ?><?php echo ($producto->id_producto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $producto_edit->RightColumnClass ?>"><div<?php echo $producto->id_producto->cellAttributes() ?>>
<span id="el_producto_id_producto">
<span<?php echo $producto->id_producto->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($producto->id_producto->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="producto" data-field="x_id_producto" name="x_id_producto" id="x_id_producto" value="<?php echo HtmlEncode($producto->id_producto->CurrentValue) ?>">
...
<?php if ($producto->id_tipo_producto->Visible) { // id_tipo_producto ?>
	<div id="r_id_tipo_producto" class="form-group row">
		<label id="elh_producto_id_tipo_producto" for="x_id_tipo_producto" class="<?php echo $producto_edit->LeftColumnClass ?>"><?php echo $producto->id_tipo_producto->caption() ?><?php echo ($producto->id_tipo_producto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $producto_edit->RightColumnClass ?>"><div<?php echo $producto->id_tipo_producto->cellAttributes() ?>>
...
<?php if ($producto->nombre_producto->Visible) { // nombre_producto ?>
	<div id="r_nombre_producto" class="form-group row">
		<label id="elh_producto_nombre_producto" for="x_nombre_producto" class="<?php echo $producto_edit->LeftColumnClass ?>"><?php echo $producto->nombre_producto->caption() ?><?php echo ($producto->nombre_producto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $producto_edit->RightColumnClass ?>"><div<?php echo $producto->nombre_producto->cellAttributes() ?>>
...
<?php if ($producto->estado_producto->Visible) { // estado_producto ?>
	<div id="r_estado_producto" class="form-group row">
		<label id="elh_producto_estado_producto" for="x_estado_producto" class="<?php echo $producto_edit->LeftColumnClass ?>"><?php echo $producto->estado_producto->caption() ?><?php echo ($producto->estado_producto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $producto_edit->RightColumnClass ?>"><div<?php echo $producto->estado_producto->cellAttributes() ?>>
...
<?php if ($producto->peso_producto->Visible) { // peso_producto ?>
	<div id="r_peso_producto" class="form-group row">
		<label id="elh_producto_peso_producto" for="x_peso_producto" class="<?php echo $producto_edit->LeftColumnClass ?>"><?php echo $producto->peso_producto->caption() ?><?php echo ($producto->peso_producto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $producto_edit->RightColumnClass ?>"><div<?php echo $producto->peso_producto->cellAttributes() ?>>
...
<?php if ($producto->descripcion_producto->Visible) { // descripcion_producto ?>
	<div id="r_descripcion_producto" class="form-group row">
		<label id="elh_producto_descripcion_producto" for="x_descripcion_producto" class="<?php echo $producto_edit->LeftColumnClass ?>"><?php echo $producto->descripcion_producto->caption() ?><?php echo ($producto->descripcion_producto->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $producto_edit->RightColumnClass ?>"><div<?php echo $producto->descripcion_producto->cellAttributes() ?>>
...
<?php if (!$producto_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $producto_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $producto_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
