...
// Create page object
$proveedor_inv_mat_add = new proveedor_inv_mat_add();

// Run the page
$proveedor_inv_mat_add->run();
...
$proveedor_inv_mat_add->Page_Render();
?>
...
var fproveedor_inv_matadd = currentForm = new ew.Form("fproveedor_inv_matadd", "add");

// Validate form
fproveedor_inv_matadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($proveedor_inv_mat_add->id_proveedor_inv_mat->Required) { ?>
		...
		<?php } ?>
		<?php if ($proveedor_inv_mat_add->id_proveedor->Required) { ?>
		...
		<?php } ?>
		<?php if ($proveedor_inv_mat_add->id_materia_prima->Required) { ?>
		...
		<?php } ?>
		<?php if ($proveedor_inv_mat_add->id_inventario->Required) { ?>
		...
		<?php } ?>
		<?php if ($proveedor_inv_mat_add->fecha_inventario->Required) { ?>
		...
		<?php } ?>
		<?php if ($proveedor_inv_mat_add->cantidad_proveedor_inv_mat->Required) { ?>
...
fproveedor_inv_matadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fproveedor_inv_matadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $proveedor_inv_mat_add->showPageHeader(); ?>
<?php
$proveedor_inv_mat_add->showMessage();
?>
<form name="fproveedor_inv_matadd" id="fproveedor_inv_matadd" class="<?php echo $proveedor_inv_mat_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($proveedor_inv_mat_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $proveedor_inv_mat_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="proveedor_inv_mat">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$proveedor_inv_mat_add->IsModal ?>">
...
<?php if ($proveedor_inv_mat->id_proveedor_inv_mat->Visible) { // id_proveedor_inv_mat ?>
	<div id="r_id_proveedor_inv_mat" class="form-group row">
		<label id="elh_proveedor_inv_mat_id_proveedor_inv_mat" for="x_id_proveedor_inv_mat" class="<?php echo $proveedor_inv_mat_add->LeftColumnClass ?>"><?php echo $proveedor_inv_mat->id_proveedor_inv_mat->caption() ?><?php echo ($proveedor_inv_mat->id_proveedor_inv_mat->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $proveedor_inv_mat_add->RightColumnClass ?>"><div<?php echo $proveedor_inv_mat->id_proveedor_inv_mat->cellAttributes() ?>>
<span id="el_proveedor_inv_mat_id_proveedor_inv_mat">
<input type="text" data-table="proveedor_inv_mat" data-field="x_id_proveedor_inv_mat" name="x_id_proveedor_inv_mat" id="x_id_proveedor_inv_mat" size="30" maxlength="15" placeholder="<?php echo HtmlEncode($proveedor_inv_mat->id_proveedor_inv_mat->getPlaceHolder()) ?>" value="<?php echo $proveedor_inv_mat->id_proveedor_inv_mat->EditValue ?>"<?php echo $proveedor_inv_mat->id_proveedor_inv_mat->editAttributes() ?>>
</span>
...
<?php if ($proveedor_inv_mat->id_proveedor->Visible) { // id_proveedor ?>
	<div id="r_id_proveedor" class="form-group row">
		<label id="elh_proveedor_inv_mat_id_proveedor" for="x_id_proveedor" class="<?php echo $proveedor_inv_mat_add->LeftColumnClass ?>"><?php echo $proveedor_inv_mat->id_proveedor->caption() ?><?php echo ($proveedor_inv_mat->id_proveedor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $proveedor_inv_mat_add->RightColumnClass ?>"><div<?php echo $proveedor_inv_mat->id_proveedor->cellAttributes() ?>>
...
<?php if ($proveedor_inv_mat->id_materia_prima->Visible) { // id_materia_prima ?>
	<div id="r_id_materia_prima" class="form-group row">
		<label id="elh_proveedor_inv_mat_id_materia_prima" for="x_id_materia_prima" class="<?php echo $proveedor_inv_mat_add->LeftColumnClass ?>"><?php echo $proveedor_inv_mat->id_materia_prima->caption() ?><?php echo ($proveedor_inv_mat->id_materia_prima->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $proveedor_inv_mat_add->RightColumnClass ?>"><div<?php echo $proveedor_inv_mat->id_materia_prima->cellAttributes() ?>>
...
<?php if ($proveedor_inv_mat->id_inventario->Visible) { // id_inventario ?>
	<div id="r_id_inventario" class="form-group row">
		<label id="elh_proveedor_inv_mat_id_inventario" for="x_id_inventario" class="<?php echo $proveedor_inv_mat_add->LeftColumnClass ?>"><?php echo $proveedor_inv_mat->id_inventario->caption() ?><?php echo ($proveedor_inv_mat->id_inventario->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $proveedor_inv_mat_add->RightColumnClass ?>"><div<?php echo $proveedor_inv_mat->id_inventario->cellAttributes() ?>>
...
<?php if ($proveedor_inv_mat->fecha_inventario->Visible) { // fecha_inventario ?>
	<div id="r_fecha_inventario" class="form-group row">
		<label id="elh_proveedor_inv_mat_fecha_inventario" for="x_fecha_inventario" class="<?php echo $proveedor_inv_mat_add->LeftColumnClass ?>"><?php echo $proveedor_inv_mat->fecha_inventario->caption() ?><?php echo ($proveedor_inv_mat->fecha_inventario->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $proveedor_inv_mat_add->RightColumnClass ?>"><div<?php echo $proveedor_inv_mat->fecha_inventario->cellAttributes() ?>>
...
<?php if ($proveedor_inv_mat->cantidad_proveedor_inv_mat->Visible) { // cantidad_proveedor_inv_mat ?>
	<div id="r_cantidad_proveedor_inv_mat" class="form-group row">
		<label id="elh_proveedor_inv_mat_cantidad_proveedor_inv_mat" for="x_cantidad_proveedor_inv_mat" class="<?php echo $proveedor_inv_mat_add->LeftColumnClass ?>"><?php echo $proveedor_inv_mat->cantidad_proveedor_inv_mat->caption() ?><?php echo ($proveedor_inv_mat->cantidad_proveedor_inv_mat->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $proveedor_inv_mat_add->RightColumnClass ?>"><div<?php echo $proveedor_inv_mat->cantidad_proveedor_inv_mat->cellAttributes() ?>>
...
<?php if (!$proveedor_inv_mat_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $proveedor_inv_mat_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $proveedor_inv_mat_add->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$proveedor_inv_mat_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$proveedor_inv_mat_add->terminate();
?>