...
// Create page object
$proveedor_edit = new proveedor_edit();
...
var fproveedoredit = currentForm = new ew.Form("fproveedoredit", "edit");
...
fproveedoredit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($proveedor_edit->id_proveedor->Required) { ?>
		...
		<?php } ?>
		<?php if ($proveedor_edit->nombre_proveedor->Required) { ?>
		...
		<?php } ?>
		<?php if ($proveedor_edit->direccion_proveedor->Required) { ?>
		...
		<?php } ?>
		<?php if ($proveedor_edit->telefono_proveedor->Required) { ?>
		...
		<?php } ?>
		<?php if ($proveedor_edit->descripcion_proveedor->Required) { ?>
...
fproveedoredit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fproveedoredit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
?>
<form name="fproveedoredit" id="fproveedoredit" class="<?php echo $proveedor_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($proveedor_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $proveedor_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="proveedor">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$proveedor_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($proveedor->id_proveedor->Visible) { // id_proveedor ?>
	<div id="r_id_proveedor" class="form-group row">
		<label id="elh_proveedor_id_proveedor" for="x_id_proveedor" class="<?php echo $proveedor_edit->LeftColumnClass ?>"><?php echo $proveedor->id_proveedor->caption() ?><?php echo ($proveedor->id_proveedor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $proveedor_edit->RightColumnClass ?>"><div<?php echo $proveedor->id_proveedor->cellAttributes() ?>>
<span id="el_proveedor_id_proveedor">
<span<?php echo $proveedor->id_proveedor->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($proveedor->id_proveedor->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="proveedor" data-field="x_id_proveedor" name="x_id_proveedor" id="x_id_proveedor" value="<?php echo HtmlEncode($proveedor->id_proveedor->CurrentValue) ?>">
...
<?php if ($proveedor->nombre_proveedor->Visible) { // nombre_proveedor ?>
	<div id="r_nombre_proveedor" class="form-group row">
		<label id="elh_proveedor_nombre_proveedor" for="x_nombre_proveedor" class="<?php echo $proveedor_edit->LeftColumnClass ?>"><?php echo $proveedor->nombre_proveedor->caption() ?><?php echo ($proveedor->nombre_proveedor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $proveedor_edit->RightColumnClass ?>"><div<?php echo $proveedor->nombre_proveedor->cellAttributes() ?>>
...
<?php if ($proveedor->direccion_proveedor->Visible) { // direccion_proveedor ?>
	<div id="r_direccion_proveedor" class="form-group row">
		<label id="elh_proveedor_direccion_proveedor" for="x_direccion_proveedor" class="<?php echo $proveedor_edit->LeftColumnClass ?>"><?php echo $proveedor->direccion_proveedor->caption() ?><?php echo ($proveedor->direccion_proveedor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $proveedor_edit->RightColumnClass ?>"><div<?php echo $proveedor->direccion_proveedor->cellAttributes() ?>>
...
<?php if ($proveedor->telefono_proveedor->Visible) { // telefono_proveedor ?>
	<div id="r_telefono_proveedor" class="form-group row">
		<label id="elh_proveedor_telefono_proveedor" for="x_telefono_proveedor" class="<?php echo $proveedor_edit->LeftColumnClass ?>"><?php echo $proveedor->telefono_proveedor->caption() ?><?php echo ($proveedor->telefono_proveedor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $proveedor_edit->RightColumnClass ?>"><div<?php echo $proveedor->telefono_proveedor->cellAttributes() ?>>
...
<?php if ($proveedor->descripcion_proveedor->Visible) { // descripcion_proveedor ?>
	<div id="r_descripcion_proveedor" class="form-group row">
		<label id="elh_proveedor_descripcion_proveedor" for="x_descripcion_proveedor" class="<?php echo $proveedor_edit->LeftColumnClass ?>"><?php echo $proveedor->descripcion_proveedor->caption() ?><?php echo ($proveedor->descripcion_proveedor->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $proveedor_edit->RightColumnClass ?>"><div<?php echo $proveedor->descripcion_proveedor->cellAttributes() ?>>
...
<?php if (!$proveedor_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $proveedor_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $proveedor_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
