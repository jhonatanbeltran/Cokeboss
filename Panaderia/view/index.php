...
header("Location: index.php");
	...
	$varG = isset($_GET['group_code']) ? $_GET['group_code'] : 0;
	$produc = new Daoproducto();
	$array = array();
	$array = $produc->findAllProductoex();
...
<!-- Bootstrap-CSS --> 	<link rel="stylesheet" href="../view/css/bootstrap.min.css"		type="text/css" media="all">
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
	 ...
	 <?php if(isset($_POST['actualizar'])){
	   ...
	   $tipo = $_POST['tipo'];
       $produc = new producto($id,$tipo,$nomb,$es,$peso,$desp);
	   $producto->updateProducto($produc);

       }  ?>
	<form action="#" method="post">
      <div class="modal-body">
      		<input type="text" hidden="" value="<?php echo $array[$varG]->getId_producto(); ?>" id="idProd" name="id">
			  <input type="text" hidden="" value="<?php echo $array[$varG]->getId_tipo_producto(); ?>" id="idProd" name="tipo">

			<label>Nombre del Producto</label>
        	<input type="text" name="nombre" value="<?php echo $array[$varG]->getNombre_producto(); ?>" id="idInv" class="form-control input-sm">
        	<label>Peso</label>
        	<input type="text" name="peso" value="<?php echo $array[$varG]->getPeso_producto(); ?>" id="cant" class="form-control input-sm">
        	<label>Descripcion</label>
        	<input type="text" name="descripcion" value="<?php echo $array[$varG]->getDescripcion_producto(); ?>" id="desc" class="form-control input-sm">
        	<label>Estado</label>
        	<input type="text" name="estado" id="est" value="<?php echo $array[$varG]->getEstado_producto(); ?>" class="form-control input-sm">
      </div>
      <div class="modal-footer">
	 <input class="submit" type="submit" name="actualizar" value= "actualizar">        </form>
      </div>
    </div>
  </div>
</div>
	...
	<div class="aitsheaderw3ls" id="agilehome">
		...
		<div class="agiletopbar">
			...
			<div class="aitslogow3ls">
					<a href="index.html"><div class="agilelogo">CakeBoss Bakery</div></a>
			</div>
	...
	<!-- Custom-JavaScript-File-Links -->
		...
		<!-- Default-JavaScript -->   <script type="text/javascript" src="../view/js/jquery-2.1.4.min.js"></script>
		<!-- Bootstrap-JavaScript --> <script type="text/javascript" src="../view/js/bootstrap.min.js"></script>
...
<script type="text/javascript">
    ...
    $('#buscador').load('../view/componentes/buscador.php');
	});
</script>
